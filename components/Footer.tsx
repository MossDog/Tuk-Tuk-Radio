  ...
  return (
    <footer className="w-full py-8 bg-gray-900 text-gray-200 border-t border-gray-800 mt-8 flex flex-col items-center">
      ...
      <div className="flex gap-6 mt-4">
        <a href="https://github.com/MossDog" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:underline">
        ...
        <a href="mailto:contact@tuktukradio.com" className="flex items-center gap-1 hover:underline">
